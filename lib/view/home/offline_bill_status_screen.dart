  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: MyText(
          text: AppLocale.offlineBills.getString(context),
          color: Colors.black,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            MyText(
                              text: '${AppLocale.offlineBills.getString(context)} (${_bills.length})',
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    child: MyText(text: AppLocale.retry.getString(context), color: white),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  MyText(
                                    text: AppLocale.noBillsFound.getString(context),
  ...
  Widget _buildBillCard(Map<String, dynamic> bill) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: MyText(
          text: '${AppLocale.billNo.getString(context)} #$billId',
          fontWeight: FontWeight.bold,
          fontSize: 15,
          maxLines: 1,
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Expanded(
              child: MyText(
                text: '${AppLocale.billNo.getString(context)} #${bill['id']?.toString() ?? 'Unknown'}',
                fontSize: 16,
                overflow: TextOverflow.ellipsis,
              ),
            ),
        ...
        actions: [
          TextButton(
            ...
            child: MyText(text: AppLocale.close.getString(context)),
          ),
        ],
      ),
    );
