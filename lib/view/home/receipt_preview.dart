          ...
          return AlertDialog(
            ...
            title:  Row(
              children: [
                ...
                MyText(text: AppLocale.confirmAction.getString(context), fontSize: 20, fontWeight: FontWeight.bold),
              ],
            ),
            content: MyText(
              text: AppLocale.areYouSureYouWantToSaveThisBillWithoutPrinting.getString(context),
              fontSize: 16,
              maxLines: 2,
            ),
            actions: [
              TextButton(
                ...
                child: MyText(text: AppLocale.cancel.getString(context), fontSize: 16),
              ),
              ElevatedButton(
                ...
                child: localLoading
                    ...
                    : MyText(text: AppLocale.save.getString(context), fontSize: 16, color: Colors.white),
              ),
            ],
          );
        });
  ...
  Widget build(BuildContext context) {
    return Consumer<PrintProvider>(
      builder: (context, printProvider, child) {
        ...
        const double roundOff = 0; // No rounding applied to maintain precision
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText(
                            text: AppLocale.toPay.getString(context),
                            fontSize: 18,
                    ...
                    Consumer<OrderTypeProvider>(
                      builder: (context, provider, _) {
                        return MyChoiceChip(
                          options: [AppLocale.cash.getString(context), AppLocale.upi.getString(context), AppLocale.debit.getString(context), AppLocale.complementary.getString(context)],
                          selectedValue: provider.paymentType == PaymentType.cash
                              ? AppLocale.cash.getString(context)
                              : provider.paymentType == PaymentType.upi
                                  ? AppLocale.upi.getString(context)
                                  : provider.paymentType == PaymentType.debit
                                      ? AppLocale.debit.getString(context)
                                      : AppLocale.complementary.getString(context),
                          onSelected: (value) {
                            provider.setPaymentType(
                              value == AppLocale.cash.getString(context)
                                  ? PaymentType.cash
                                  : value == AppLocale.upi.getString(context)
                                      ? PaymentType.upi
                                      : value == AppLocale.debit.getString(context)
                                          ? PaymentType.debit
                        ...
                        _buildIconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (!printProvider.isConnected || printProvider.selectedPrinter == null) {
                              SnackBarUtils.showWarning(context, AppLocale.pleaseConnectPrinterFirst.getString(context));
                              return;
                            }
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        MyText(
                          text: AppLocale.cartIsEmptyLabel.getString(context),
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        MyText(
                          text: '${AppLocale.contact.getString(context)}: ${widget.contact}',
                          fontSize: 14,
                          color: Colors.grey[700],
                        ),
                        ...
                        Center(
                          child: MyText(
                            text: AppLocale.addCustomerDetails.getString(context),
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: appbar1,
                          ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  labelText: AppLocale.selectStaff.getString(context),
                        ...
                        Center(
                          child: Row(
                            ...
                            children: [
                              MyText(
                                text: AppLocale.itemList.getString(context),
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: appbar1,
                              ),
                              GestureDetector(
                                ...
                                child: Container(
                                    ...
                                    child: MyText(
                                      text: AppLocale.addItem.getString(context),
                                      color: Colors.white,
                                    )),
                              )
                            ],
                        ...
                        Table(
                          ...
                          children: [
                            ...
                            TableRow(
                              ...
                              children: [
                                _buildCell(
                                  text: AppLocale.item.getString(context),
                                  fontWeight: FontWeight.bold,
                        ...
                        TextFormField(
                          ...
                          style: const TextStyle(color: Colors.black, fontSize: 15),
                          decoration: InputDecoration(
                            hintText: AppLocale.enterNote.getString(context),
                            enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                            ),
                            focusedBorder: OutlineInputBorder(
                        ...
                        MyText(
                          text: AppLocale.billSummary.getString(context),
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: appbar1,
                        ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                _billRow(AppLocale.itemTotal.getString(context), subtotal),
                                if (discountAmount > 0)
                                  _billRow(
                                ...
                                if (taxEnabled) ...[
                                  _billRow('${AppLocale.cgst.getString(context)}${PriceUtils.formatPrice(cgstPercent).substring(1)}%)', cgstAmount),
                                  _billRow('${AppLocale.sgst.getString(context)}${PriceUtils.formatPrice(sgstPercent).substring(1)}%)', sgstAmount)
                                ],
                                if (roundOff != 0)
                                  _billRow(
                                    AppLocale.roundOff.getString(context),
                                    roundOff,
