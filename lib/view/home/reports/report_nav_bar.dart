...
class _ReportNavBarState extends State<ReportNavBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _buildNavChip(context, 'Sales', const SalesReportScreen(), AppLocale.sales.getString(context)),
          _buildNavChip(context, 'Bill-wise', const BillwiseReportScreen(), AppLocale.billWise.getString(context)),
          _buildNavChip(context, 'Item-wise', const ItemwiseReportScreen(), AppLocale.itemWise.getString(context)),
          _buildNavChip(context, 'Date-wise', const DatewiseReportScreen(), AppLocale.dateWise.getString(context)),
          _buildNavChip(context, 'Customer-wise', const CustomerWiseReport(), AppLocale.customerWise.getString(context)),
          if (showStaffWise)
            _buildNavChip(context, 'Staff-wise', const StaffWiseReportScreen(), AppLocale.staffWise.getString(context)),
  ...
  Widget _buildNavChip(BuildContext context, String id, Widget screen, String displayLabel) {
