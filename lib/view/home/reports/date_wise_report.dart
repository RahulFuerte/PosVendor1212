...
class DatewiseReportScreen extends StatefulWidget {
  const DatewiseReportScreen({Key? key}) : super(key: key);
...
class _DatewiseReportScreenState extends State<DatewiseReportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(
          text: AppLocale.dateWiseReport.getString(context),
                ...
                child: Row(
                  children: [
                    _buildSummaryMiniCard(
                      AppLocale.totalDays.getString(context).toUpperCase(),
                    ...
                    _buildSummaryMiniCard(
                      AppLocale.totalBills.getString(context).toUpperCase(),
                      totalBills.toString(),
                    ...
                    const SizedBox(width: 10),
                    _buildSummaryMiniCard(
                      AppLocale.netRevenue.getString(context).toUpperCase(),
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            MyText(
                              text: fromDate == null || toDate == null ? AppLocale.chooseADateRange.getString(context).toUpperCase() : AppLocale.noDataFound.getString(context).toUpperCase(),
                              color: Colors.grey[400],
                              fontSize: 13,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          _buildBadge(
                                              '${date['totalBills']} ${AppLocale.bills.getString(context).toUpperCase()}', Icons.receipt_rounded, Colors.blue),
                                          const SizedBox(height: 12),
                                          MyText(
                                            text: AppLocale.dailySales.getString(context).toUpperCase(),
                                            color: Colors.grey[400],
                                            fontSize: 9,
                                            fontWeight: FontWeight.w600,
                                            letterSpacing: 1,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          MyText(
                                            text: AppLocale.totalCollected.getString(context).toUpperCase(),
                                            color: Colors.grey[400],
                                            fontSize: 9,
                                            fontWeight: FontWeight.w600,
                                            letterSpacing: 1,
  ...
  Future<void> _downloadAndShareReport() async {
    ...
    try {
      ...
      SnackBarUtils.showSuccess(context, AppLocale.pdfGeneratedSuccessfully.getString(context));
    } catch (e) {
