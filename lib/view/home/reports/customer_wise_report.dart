...
class _CustomerWiseReportState extends State<CustomerWiseReport> {
  ...
  Future<void> fetchCustomerTransactions(CustomerModel customer) async {
    ...
    if (customer.id == null) {
      SnackBarUtils.showError(
          context, AppLocale.customerIdMissing.getString(context));
      return;
    }
    ...
    try {
      ...
      final processedBills = bills.map((bill) {
        ...
        return {
          'billNo':
              bill['billNumber'] ?? bill['receiptNo'] ?? bill['_id'] ?? 'N/A',
          'time': DateFormat('hh:mm a').format(billDate),
          'items': (bill['items'] as List<dynamic>?)?.length ?? 0,
          'allItems': bill['items'],
          'amount':
              (bill['finalAmount'] ?? bill['totalAmount'] ?? 0).toDouble(),
          'paymentType':
      ...
      setState(() {
        ...
        totalPaid = (reportData['paidAmount'] ?? reportData['totalPaid'] ?? 0.0)
            .toDouble();
        totalDue = (reportData['dueAmount'] ?? reportData['totalDue'] ?? 0.0)
            .toDouble();
  ...
  Future<void> _downloadAndShareReport() async {
    SnackBarUtils.showWarning(
        context, AppLocale.noDataAvailableToGenerateReport.getString(context));
    ...
    try {
          ...
          pdf.addPage(
            pw.MultiPage(
              ...
              build: (_) => [
                ...
                pw.Center(
                  child: pw.Text(
                    AppLocale.customerWiseSalesReport.getString(context),
                    style: pw.TextStyle(
                        fontSize: 16,
                        fontWeight: pw.FontWeight.bold,
                ...
                pw.Center(
                  child: pw.Text(
                    '${AppLocale.generatedOnPrefix.getString(context)}${DateFormat('dd MMM yyyy, hh:mm a').format(DateTime.now())}',
                  ...
                  child: pw.Row(
                    ...
                    children: [
                      pw.Column(
                        ...
                        children: [
                          pw.Text(
                            AppLocale.customerDetailsUppercase
                                .getString(context),
                            style: pw.TextStyle(
                                fontSize: 8,
                                fontWeight: pw.FontWeight.bold,
                          ...
                          pw.Text(
                              '${AppLocale.phonePrefix.getString(context)}${selectedCustomer!.phone}',
                              style: const pw.TextStyle(fontSize: 10)),
                          if (selectedCustomer!.gstNo != null &&
                              selectedCustomer!.gstNo!.isNotEmpty)
                            pw.Text(
                                '${AppLocale.gstPrefix.getString(context)}${selectedCustomer!.gstNo}',
                                style: const pw.TextStyle(fontSize: 10)),
                        ],
                      ),
                      pw.Column(
                        ...
                        children: [
                          pw.Text(
                            AppLocale.reportPeriodUppercase.getString(context),
                            style: pw.TextStyle(
                                fontSize: 8,
                                fontWeight: pw.FontWeight.bold,
                                color: PdfColors.grey600),
                          ...
                          pw.Text(
                              '${AppLocale.ordersPrefix.getString(context)}$totalOrders',
                              style: const pw.TextStyle(fontSize: 10)),
                        ],
                      ),
                    ],
                ...
                pw.Table(
                  ...
                  children: [
                    ...
                    pw.TableRow(
                      ...
                      children: [
                        _pdfHeaderCell(AppLocale.billNo.getString(context)),
                        _pdfHeaderCell(AppLocale.date.getString(context)),
                        _pdfHeaderCell(AppLocale.items.getString(context)),
                        _pdfHeaderCell(AppLocale.modeHeader.getString(context)),
                        _pdfHeaderCell(
                            AppLocale.amountHeader.getString(context),
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Container(
                      ...
                      child: pw.Column(
                        children: [
                          _pdfSummaryRow(AppLocale.totalPaid.getString(context),
                              totalPaid, PdfColors.green900),
                          pw.SizedBox(height: 4),
                          _pdfSummaryRow(AppLocale.totalDue.getString(context),
                              totalDue, PdfColors.red900),
                          pw.Divider(thickness: 1),
                          _pdfSummaryRow(
                              AppLocale.grandTotal.getString(context),
                              totalPaid + totalDue,
                ...
                pw.Center(
                  child: pw.Text(
                    AppLocale.computerGeneratedReport.getString(context),
                    style: const pw.TextStyle(
      ...
      SnackBarUtils.showSuccess(
          context, AppLocale.pdfGeneratedSuccessfully.getString(context));
    } catch (e) {
  ...
  pw.Widget _pdfSummaryRow(String label, double value, PdfColor color,
      {bool isFinal = false}) {
    return pw.Row(
      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      children: [
  ...
  Future<void> _handlePrint() async {
    ...
    if (!printProvider.isConnected || printProvider.selectedPrinter == null) {
      ...
      SnackBarUtils.showWarning(
          context, AppLocale.pleaseConnectAPrinterFirst.getString(context));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(context, rootNavigator: true).pop();
        SnackBarUtils.showError(
            context, '${AppLocale.printFailed.getString(context)}: $e');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(
          text: AppLocale.customerWiseReport.getString(context),
          color: Colors.black,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<CustomerModel>(
                      ...
                      isExpanded: true,
                      hint: MyText(
                          text: AppLocale.selectCustomer.getString(context)),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: _dateField(
                          label: AppLocale.startDate.getString(context),
                          date: startDate,
                          onTap: () => pickDate(true),
                        ),
                      ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color:
                          selectedCustomer != null ? appbar1 : Colors.grey[400],
                    ),
                    child: Center(
                      child: MyText(
                        text: AppLocale.findBills.getString(context),
                        color: white,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                      ),
                      ...
                      : customerBills.isEmpty
                          ? Center(
                              child: Padding(
                                ...
                                child: MyText(
                                  text: AppLocale
                                      .noTransactionsFoundForSelectedCustomer
                                      .getString(context),
                                  color: Colors.grey,
                                  fontSize: 16,
                                ),
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              MyText(
                                                text:
                                                    "$totalOrders ${AppLocale.orders.getString(context)}",
                                                color: Colors.white70,
                                                fontSize: 13,
                                              ),
                                            ],
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      MyText(
                                        text:
                                            AppLocale.bills.getString(context),
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ],
                                  ...
                                  return Container(
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        title: MyText(
                                          text:
                                              "${AppLocale.billNo.getString(context)}: ${bill['billNo']}",
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15,
                                        ),
                                        subtitle: Column(
                                          ...
                                          children: [
                                            MyText(
                                              text:
                                                  "${bill['items']} ${AppLocale.items.getString(context)} • ${bill['date']} ${bill['time']}",
                                              fontSize: 13,
                                            ...
                                            MyText(
                                              text:
                                                  "${AppLocale.payment.getString(context)}: ${_formatPaymentType(bill['paymentType'])}",
                                              fontSize: 12,
