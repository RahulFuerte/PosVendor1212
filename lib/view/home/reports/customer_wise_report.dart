...
class _CustomerWiseReportState extends State<CustomerWiseReport> {
  ...
  Future<void> fetchCustomerTransactions(CustomerModel customer) async {
    ...
    if (customer.id == null) {
      SnackBarUtils.showError(context, AppLocale.customerIdMissing.getString(context));
      return;
    }
    ...
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.errorLoadingData.getString(context)}: $e');
    } finally {
  ...
  Future<void> _downloadAndShareReport() async {
    SnackBarUtils.showWarning(context, AppLocale.noDataAvailableToGenerateReport.getString(context));
    ...
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.pdfGenerationFailed.getString(context)}: $e');
    }
  }
  ...
  Future<void> _handlePrint() async {
    ...
    if (!printProvider.isConnected || printProvider.selectedPrinter == null) {
      ...
      SnackBarUtils.showWarning(context, AppLocale.pleaseConnectAPrinterFirst.getString(context));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(context, rootNavigator: true).pop();
        SnackBarUtils.showError(context, '${AppLocale.printFailed.getString(context)}: $e');
      }
    }
  }
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<CustomerModel>(
                      ...
                      isExpanded: true,
                      hint: MyText(text: AppLocale.selectCustomer.getString(context)),
                      ...
                      : customerBills.isEmpty
                          ? Center(
                              child: Padding(
                                ...
                                child: MyText(
                                  text: AppLocale.noTransactionsFoundForSelectedCustomer.getString(context),
                                  color: Colors.grey,
                                  fontSize: 16,
                                ),
                              ),
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              MyText(
                                                text: "$totalOrders ${AppLocale.orders.getString(context)}",
                                                color: Colors.white70,
                                                fontSize: 13,
                                              ),
                                            ],
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            child: _amountTile(
                                              title: AppLocale.paid.getString(context),
                                              value: totalPaid,
                                          ...
                                          Expanded(
                                            child: _amountTile(
                                              title: AppLocale.due.getString(context),
                                              value: totalDue,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      MyText(
                                        text: AppLocale.bills.getString(context),
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ],
                                  ...
                                  return Container(
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        title: MyText(
                                          text: "${AppLocale.billNo.getString(context)}: ${bill['billNo']}",
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15,
                                        ),
                                        subtitle: Column(
                                          ...
                                          children: [
                                            MyText(
                                              text: "${bill['items']} ${AppLocale.items.getString(context)} • ${bill['date']} ${bill['time']}",
                                              fontSize: 13,
                                              color: Colors.grey[600],
                                            ),
                                            const SizedBox(height: 2),
                                            MyText(
                                              text: "${AppLocale.payment.getString(context)}: ${_formatPaymentType(bill['paymentType'])}",
                                              fontSize: 12,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            MyText(
              text: date == null ? AppLocale.selectDate.getString(context) : DateFormat('dd MMM yyyy').format(date),
              fontSize: 15,
              fontWeight: FontWeight.bold,
            ),
          ],
