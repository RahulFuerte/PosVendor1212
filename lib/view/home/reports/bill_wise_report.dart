...
class _BillwiseReportScreenState extends State<BillwiseReportScreen> {
  ...
  Future<void> _fetchBillsData() async {
    if (fromDate == null || toDate == null) {
      SnackBarUtils.showWarning(context, AppLocale.pleaseSelectBothDates.getString(context));
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        SnackBarUtils.showError(context, '${AppLocale.errorFetchingData.getString(context)}: $e');
      }
    } finally {
      setState(() {
        isLoading = false;
  ...
  Future<void> _printThermalReceipt() async {
    ...
    if (billsData.isEmpty) {
      SnackBarUtils.showWarning(context, AppLocale.noDataToPrint.getString(context));
      return;
    }

    final printer = printProvider.selectedPrinter;
    if (printer == null) {
      SnackBarUtils.showWarning(context, AppLocale.pleaseSelectAPrinterFirst.getString(context));
      return;
    }
    ...
    try {
      ...
      SnackBarUtils.showSuccess(context, AppLocale.reportPrintedSuccessfully.getString(context));
    } catch (e) {
      if (mounted) {
        Navigator.of(context, rootNavigator: true).pop();
      }
      SnackBarUtils.showError(context, '${AppLocale.printError.getString(context)}: $e');
    }
  }

  Future<void> _downloadAndShareReport() async {
    if (billsData.isEmpty) {
      SnackBarUtils.showWarning(context, AppLocale.noDataAvailable.getString(context));
      return;
    }
    try {
      showDialog(
      ...
      SnackBarUtils.showError(context, '${AppLocale.errorCreatingPdf.getString(context)}: $e');
    }
  }
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    MyText(
                                        text: AppLocale.from.getString(context).toUpperCase(),
                                        fontSize: 10,
                                        color: Colors.grey[400],
                                        fontWeight: FontWeight.bold,
                                        letterSpacing: 1.2),
                                    MyText(
                                      text: fromDate == null ? AppLocale.select.getString(context) : DateFormat('dd MMM yyyy').format(fromDate!),
                                      fontSize: 14,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    MyText(
                                        text: AppLocale.to.getString(context).toUpperCase(),
                                        fontSize: 10,
                                        color: Colors.grey[400],
                                        fontWeight: FontWeight.bold,
                                        letterSpacing: 1.2),
                                    MyText(
                                      text: toDate == null ? AppLocale.select.getString(context) : DateFormat('dd MMM yyyy').format(toDate!),
                                      fontSize: 14,
                                      fontWeight: FontWeight.w700,
                                    ),
                                  ],
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            MyText(
                              text:
                                  fromDate == null || toDate == null ? AppLocale.chooseADateRange.getString(context).toUpperCase() : AppLocale.noTransactionsFound.getString(context).toUpperCase(),
                              color: Colors.grey[400],
                              fontSize: 13,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              MyText(
                                                text: bill['customerName']?.toString().toUpperCase() ?? AppLocale.walkIn.getString(context).toUpperCase(),
                                                fontWeight: FontWeight.w600,
                                                fontSize: 16,
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  _buildBadge('${bill['totalItems'].toInt()} ${AppLocale.items.getString(context)}',
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              MyText(
                                                text: AppLocale.totalPaid.getString(context).toUpperCase(),
                                                color: Colors.grey[400],
                                                fontSize: 9,
                                                fontWeight: FontWeight.w600,
                                                letterSpacing: 1,
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            _miniDetail(AppLocale.subtotal.getString(context).toUpperCase(), PriceUtils.formatPrice(bill['totalAmount'])),
                                            _miniDetail(AppLocale.discount.getString(context).toUpperCase(), PriceUtils.formatPrice(bill['discount']),
                                                isRed: true),
                                            _miniDetail(AppLocale.taxPaid.getString(context).toUpperCase(), PriceUtils.formatPrice(bill['tax'])),
                                          ],
                                        ),
                                      ),
                                    ],
