...
class ItemwiseReportScreen extends StatefulWidget {
  const ItemwiseReportScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(
          text: AppLocale.itemWiseReport.getString(context),
                ...
                child: Row(
                  children: [
                    _buildSummaryMiniCard(
                      AppLocale.totalItems.getString(context).toUpperCase(),
                    ...
                    _buildSummaryMiniCard(
                      AppLocale.totalQty.getString(context).toUpperCase(),
                    ...
                    const SizedBox(width: 10),
                    _buildSummaryMiniCard(
                      AppLocale.netSales.getString(context).toUpperCase(),
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            MyText(
                              text: fromDate == null || toDate == null ? AppLocale.chooseADateRange.getString(context).toUpperCase() : AppLocale.noItemsFound.getString(context).toUpperCase(),
                              color: Colors.grey[400],
                              fontSize: 13,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          _buildBadge('${item['quantity'].toStringAsFixed(1)} ${AppLocale.sold.getString(context).toUpperCase()}',
                                              Icons.shopping_cart_rounded, Colors.orange.shade800),
                                          const SizedBox(height: 12),
                                          MyText(
                                            text: AppLocale.quantityMetric.getString(context).toUpperCase(),
                                            color: Colors.grey[400],
                                            fontSize: 9,
                                            fontWeight: FontWeight.w600,
                                            letterSpacing: 1,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          MyText(
                                            text: AppLocale.totalSales.getString(context).toUpperCase(),
                                            color: Colors.grey[400],
                                            fontSize: 9,
                                            fontWeight: FontWeight.w600,
                                            letterSpacing: 1,
