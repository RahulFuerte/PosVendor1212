                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          _buildBadge(
                                              '${item['quantity'].toStringAsFixed(1)} SOLD',
                                              Icons.shopping_cart_rounded,
                                              Colors.orange.shade800),
                                          const SizedBox(height: 12),
                                          MyText(
                                            text: AppLocale.quantityMetric
                                                .getString(context)
                                                .toUpperCase(),
                                            color: Colors.grey[400],
                                            fontSize: 9,
    ...
    try {
      ...
      final processedData = report.map((item) {
        ...
        final qty = (item['quantitySold'] ??
            ...
            .toDouble();
        final amt =
            (item['totalSales'] ?? item['totalAmount'] ?? item['amount'] ?? 0)
                .toDouble();
                    ...
                    children: [
                      pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text('Total Qty: $totalQuantity',
                              style:
                                  pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                        ],
                      ),
