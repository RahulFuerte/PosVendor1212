...
class _StaffWiseReportScreenState extends State<StaffWiseReportScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.errorLoadingStaff.getString(context)}: $e');
    }
  }

  Future<void> _fetchReport() async {
    if (fromDate == null || toDate == null) {
      SnackBarUtils.showWarning(context, AppLocale.pleaseSelectDateRange.getString(context));
      return;
    }
    ...
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.errorFetchingReport.getString(context)}: $e');
    }
  }
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                MyText(
                                  text: AppLocale.orderHistory.getString(context),
                                  fontWeight: FontWeight.w700,
                                  fontSize: 18,
                                  color: const Color(0xFF1E293B),
                                ),
                                Container(
                                  ...
                                  child: MyText(
                                    text: '${orders.length} ${AppLocale.orders.getString(context)}',
                                    fontSize: 12,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                hint: MyText(text: AppLocale.chooseAStaffMember.getString(context), color: const Color(0xFF64748B), fontSize: 14),
                items: staffList
          ...
          Row(
            children: [
              Expanded(child: _dateTile(AppLocale.fromDate.getString(context), fromDate, true)),
              const SizedBox(width: 12),
              Expanded(child: _dateTile(AppLocale.toDate.getString(context), toDate, false)),
            ],
          ),
        ],
      ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                MyText(
                  text: date == null ? AppLocale.select.getString(context) : DateFormat('dd MMM, yy').format(date),
                  fontSize: 13,
                  fontWeight: FontWeight.w700,
                  color: const Color(0xFF1E293B),
                ),
  ...
  Future<void> _saveAsPdf() async {
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.pdfError.getString(context)}: $e');
    }
  }
  ...
  Future<void> _printReport() async {
    ...
    try {
      ...
      SnackBarUtils.showSuccess(context, AppLocale.reportPrinted.getString(context));
    } catch (e) {
      if (mounted) {
        Navigator.of(context, rootNavigator: true).pop();
      }
