...
class _StaffWiseReportScreenState extends State<StaffWiseReportScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      ...
      SnackBarUtils.showError(
          context, '${AppLocale.errorLoadingStaff.getString(context)}: $e');
    }
  }
  ...
  Future<void> _fetchReport() async {
    if (fromDate == null || toDate == null) {
      SnackBarUtils.showWarning(
          context, AppLocale.pleaseSelectDateRange.getString(context));
      return;
    }
    ...
    try {
      ...
      SnackBarUtils.showError(
          context, '${AppLocale.errorFetchingReport.getString(context)}: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: MyText(
          text: AppLocale.staffPerformance.getString(context),
          fontSize: 17,
      ...
      body: Column(
        children: [
          ReportNavBar(
              currentReport: 'Staff-wise', uid: uid, adminUid: adminUid),
          Expanded(
            child: isLoading
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                MyText(
                                  text:
                                      AppLocale.orderHistory.getString(context),
                                ...
                                Container(
                                  ...
                                  child: MyText(
                                    text:
                                        '${orders.length} ${AppLocale.orders.getString(context)}',
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                                    color: primaryColor,
                                  ),
  ...
  Widget _buildFilterSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          MyText(
            text: AppLocale.selectFilters.getString(context),
            fontSize: 14,
            fontWeight: FontWeight.w600,
            color: Colors.grey,
          ),
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                hint: MyText(
                    text: AppLocale.chooseAStaffMember.getString(context),
          ...
          Row(
            children: [
              Expanded(
                  child: _dateTile(
                      AppLocale.fromDate.getString(context), fromDate, true)),
              const SizedBox(width: 12),
              Expanded(
                  child: _dateTile(
                      AppLocale.toDate.getString(context), toDate, false)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildSummaryCards() {
    return Padding(
      ...
      child: Row(
        children: [
          _summaryCard(
            AppLocale.totalOrders.getString(context),
          ...
          _summaryCard(
            AppLocale.netRevenue.getString(context),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    MyText(
                      text:
                          DateFormat('hh:mm a, dd MMM').format(date.toLocal()),
                      color: Colors.grey,
                      fontSize: 11,
          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: MyText(
                  text: AppLocale.paid.getString(context),
                  fontSize: 10,
                  fontWeight: FontWeight.w700,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          MyText(
            text: AppLocale.noOrdersFoundForThisStaff.getString(context),
            color: const Color(0xFF64748B),
            fontSize: 16,
            fontWeight: FontWeight.w600,
          ),
          ...
          MyText(
            text: AppLocale.trySelectingADifferentDateRange.getString(context),
            color: Colors.grey,
            fontSize: 13,
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          MyText(
            text: AppLocale.selectAStaffMember.getString(context),
            fontSize: 20,
            fontWeight: FontWeight.w800,
            color: const Color(0xFF1E293B),
          ),
          ...
          Padding(
            ...
            child: MyText(
              text: AppLocale.chooseAStaffMemberDesc.getString(context),
  ...
  Future<void> _saveAsPdf() async {
    try {
      ...
      final staffName =
          staffList.firstWhere((s) => s.id == selectedStaffId).name;
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          build: (context) => [
            ...
            pw.Center(
                child: pw.Text('Staff Performance Report',
                    style: const pw.TextStyle(fontSize: 18))),
            pw.Center(
                child: pw.Text('Staff: $staffName',
      ...
      SnackBarUtils.showError(
          context, '${AppLocale.pdfError.getString(context)}: $e');
    }
  }
  ...
  Future<void> _printReport() async {
    ...
    if (!printProvider.isConnected) {
      await showDialog(
          context: context, builder: (_) => const PrinterConnectionDialog());
    ...
    try {
      ...
      bytes += generator.row([
        PosColumn(
            text: 'Summary', width: 6, styles: const PosStyles(bold: true)),
        PosColumn(
            text: 'Value',
            width: 6,
      ...
      bytes += generator.hr();
      bytes +=
          generator.text('RECENT ORDERS', styles: const PosStyles(bold: true));
      bytes += generator.row([
        PosColumn(
            text: 'Bill #', width: 4, styles: const PosStyles(bold: true)),
        PosColumn(
            text: 'Date',
            width: 4,
      ...
      await PrinterManager.instance
          .send(type: printProvider.selectedPrinter!.typePrinter, bytes: bytes);
      SnackBarUtils.showSuccess(
          context, AppLocale.reportPrinted.getString(context));
    } catch (e) {
      if (mounted) {
        Navigator.of(context, rootNavigator: true).pop();
      }
