...
class _SalesReportScreenState extends State<SalesReportScreen> {
  ...
  Future<void> fetchSalesData() async {
    ...
    try {
      ...
      SnackBarUtils.showError(context, '${AppLocale.error.getString(context)}: ${e.toString()}');
    }
  }
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  MyText(
                                    text: AppLocale.totalSales.getString(context),
                                    color: Colors.white,
                                    fontSize: 18,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              if (!isLoading)
                                MyText(
                                  text: '${productSales.length} ${AppLocale.items.getString(context)}',
                                  fontSize: 14,
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            MyText(
                              text: AppLocale.noSalesDataAvailable.getString(context),
                              fontSize: 16,
                              color: Colors.grey[600],
                              fontWeight: FontWeight.w500,
                            ),
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            MyText(
                                              text: '${PriceUtils.formatPrice(product['price'])} ${AppLocale.perUnit.getString(context)}',
                                              fontSize: 13,
                                              color: Colors.grey[600],
                                            ),
                                          ],
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: MyText(
                                              text: '${product['quantity']} ${AppLocale.sold.getString(context)}',
                                              fontSize: 12,
                                              fontWeight: FontWeight.w600,
                                  ...
                                  MyText(
                                    text: '${percentage.toStringAsFixed(1)}% ${AppLocale.ofTopSeller.getString(context)}',
                                    fontSize: 12,
                                    color: Colors.grey[600],
