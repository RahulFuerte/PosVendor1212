...
class _BillCartState extends State<BillCart> {
  ...
  void _onTourStateChanged() {
    if (!mounted) return;
    if (widget.isRestaurantScreen != true) return;
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.shopping_cart_outlined, size: 16, color: appbar1),
            ...
            children: [
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.shopping_cart_outlined, size: 14, color: appbar1),
                    const SizedBox(width: 6),
                    MyText(
                      text: '${selectedItemsDetails.length} ${AppLocale.items.getString(context)}',
                      color: appbar1,
