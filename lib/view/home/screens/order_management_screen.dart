...
class _OrderManagementScreenState extends State<OrderManagementScreen> {
  ...
  String _orderTypeText(String? type) {
    if (type == null) return '';
    String t = type.toLowerCase();
    if (t == 'dinein') return businessCategory == 'Food' ? AppLocale.dineIn.getString(context) : '';
    if (t == 'pickup') return businessCategory == 'Food' ? AppLocale.pickUp.getString(context) : '';
    if (t == 'delivery') return AppLocale.delivery.getString(context);
    return type;
  }
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (customerName.isEmpty && order.unknownCustomerId != null) {
                                customerName = AppLocale.guestUser.getString(context);
                              }
  ...
  Widget _buildFilters() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          MyText(text: AppLocale.filterOrders.getString(context), fontSize: 16, fontWeight: FontWeight.w600),
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.calendar_month, color: appbar1, size: 20),
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: [
                    DropdownMenuItem(value: 'all', child: MyText(text: AppLocale.allOrders.getString(context))),
                    if (businessCategory == 'Food') ...[
                      DropdownMenuItem(
                          value: 'DineIn', child: MyText(text: '🍽 ${AppLocale.dineIn.getString(context)}')),
                      DropdownMenuItem(
                          value: 'PickUp', child: MyText(text: '🛍 ${AppLocale.pickUp.getString(context)}')),
                    ],
                    DropdownMenuItem(
                        value: 'Delivery', child: MyText(text: '🚚 ${AppLocale.delivery.getString(context)}')),
                  ],
                  onChanged: (value) {
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.payment, color: appbar1, size: 20),
            ),
            items: [
              DropdownMenuItem(value: 'all', child: MyText(text: AppLocale.allPaymentMethods.getString(context))),
              DropdownMenuItem(value: 'Cash', child: MyText(text: '💵 ${AppLocale.cash.getString(context)}')),
              DropdownMenuItem(value: 'Card', child: MyText(text: '💳 ${AppLocale.card.getString(context)}')),
              DropdownMenuItem(value: 'UPI', child: MyText(text: '📱 ${AppLocale.upi.getString(context)}')),
              DropdownMenuItem(
                  value: 'Complementory',
                  child: MyText(text: '🎁 ${AppLocale.complementary.getString(context)}')),
            ],
            onChanged: (value) {
