...
class _AddItemScreenState extends State<AddItemScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              MyText(text: AppLocale.productImage.getString(context), fontSize: 18, fontWeight: FontWeight.bold),
  ...
  Future<void> _handleSubmit() async {
    ...
    if (selectedCategoryId == null) {
      SnackBarUtils.showWarning(context, AppLocale.pleaseSelectCategory.getString(context));
      return;
    }
    ...
    try {
      ...
      if (_isEditing) {
        ...
        SnackBarUtils.showSuccess(context, '${AppLocale.updateProduct.getString(context)}!');
      } else {
        ...
        SnackBarUtils.showSuccess(context, '${AppLocale.addProduct.getString(context)}!');
        _clearForm();
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(
          text: _isEditing ? AppLocale.editProduct.getString(context) : AppLocale.addNewProduct.getString(context),
          color: Colors.black,
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  MyText(text: AppLocale.changePhoto.getString(context), color: primaryColor, fontWeight: FontWeight.w700, fontSize: 13),
                ],
              ),
            ),
          ),
  ...
  Widget _imgPlaceholder() => Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          MyText(
              text: AppLocale.tapToAddImage.getString(context),
              color: primaryColor.withOpacity(0.8),
              fontWeight: FontWeight.w600,
              fontSize: 16),
          const SizedBox(height: 6),
          MyText(text: AppLocale.galleryOrCamera.getString(context), color: Colors.grey.shade600, fontSize: 13),
        ]),
      );
  ...
  Widget _buildBasicInfo() => _sectionCard(
        title: AppLocale.basicInformation.getString(context),
        icon: Icons.info_outline_rounded,
        child: Column(children: [
          // Category
          DropdownButtonFormField<String>(
            value: selectedCategoryId,
            decoration: _dec(AppLocale.category.getString(context), Icons.category_rounded),
            items: categories.map((c) => DropdownMenuItem(value: c.id, child: MyText(text: c.name))).toList(),
            onChanged: (v) => setState(() => selectedCategoryId = v),
            validator: (v) => v == null ? AppLocale.categoryRequired.getString(context) : null,
          ),
          const SizedBox(height: 16),
          TextFormField(
            controller: foodNameController,
            textCapitalization: TextCapitalization.words,
            decoration: _dec(AppLocale.productName.getString(context), Icons.shopping_bag_rounded),
            validator: (v) => v == null || v.trim().isEmpty ? AppLocale.nameRequired.getString(context) : null,
          ),
          const SizedBox(height: 16),
          TextFormField(
            controller: foodCodeController,
            decoration: _dec(AppLocale.itemCodePlu.getString(context), Icons.qr_code_rounded),
          ...
          if (businessCategory == 'Retail') ...[
            ...
            TextFormField(
              ...
              decoration: _dec(AppLocale.barcodeLabel.getString(context), Icons.barcode_reader).copyWith(
          ...
          DropdownButtonFormField<String>(
            value: baseVarient,
            decoration: _dec(AppLocale.itemUnit.getString(context), Icons.scale_rounded),
  ...
  Widget _buildPricingSection() => _sectionCard(
        title: AppLocale.pricingSection.getString(context),
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Row(
              children: [AppLocale.fixedPrice.getString(context), AppLocale.openPrice.getString(context)].map((type) {
                final rawType = type == AppLocale.fixedPrice.getString(context) ? 'Fixed' : 'Open';
                final isSel = priceType == rawType;
                return Expanded(
          ...
          TextFormField(
            ...
            decoration: _dec(AppLocale.price1Label.getString(context), Icons.currency_rupee_rounded),
            validator: (v) =>
                v == null || v.trim().isEmpty || double.tryParse(v.trim()) == null ? AppLocale.validPriceRequired.getString(context) : null,
          ),
          const SizedBox(height: 16),
          Row(children: [
            Expanded(
                child: TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    readOnly: priceType == 'Open',
                    decoration: _dec(AppLocale.price2Label.getString(context), Icons.currency_rupee))),
            ...
            Expanded(
                child: TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    readOnly: priceType == 'Open',
                    decoration: _dec(AppLocale.price3Label.getString(context), Icons.currency_rupee))),
          ]),
        ]),
      );

  Widget _buildVariantsSection() => _sectionCard(
        title: AppLocale.variantsSection.getString(context),
        icon: Icons.tune_rounded,
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SwitchListTile(
            contentPadding: EdgeInsets.zero,
            title: MyText(text: AppLocale.enableVariants.getString(context), fontWeight: FontWeight.w700, fontSize: 16),
            subtitle: MyText(
                text: AppLocale.variantsSubtitle.getString(context), fontSize: 13, color: Colors.grey.shade600),
          ...
          if (enableVariants) ...[
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: _dec(AppLocale.variantUnit.getString(context), Icons.scale_rounded),
            ...
            if (selectedVariantUnit == 'Size') ...[
              DropdownButtonFormField<String>(
                value: selectedSize,
                hint: MyText(text: AppLocale.selectSize.getString(context)),
                decoration: _dec(AppLocale.sizeLabel.getString(context), Icons.straighten_rounded),
            ...
            if (selectedVariantUnit != 'Size') ...[
              TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: _dec(AppLocale.variantQty.getString(context), Icons.numbers_rounded)),
              const SizedBox(height: 16),
            ],
            TextFormField(
                controller: variantPriceController,
                keyboardType: TextInputType.number,
                decoration: _dec(AppLocale.variantPrice.getString(context), Icons.currency_rupee_rounded)),
            const SizedBox(height: 16),
            SizedBox(
              width: double.infinity,
              height: 48,
              child: OutlinedButton.icon(
                ...
                label: MyText(text: AppLocale.addVariant.getString(context), fontWeight: FontWeight.bold, fontSize: 15),
              ),
            ),
  ...
  Widget _buildAddonsSection() => _sectionCard(
        title: AppLocale.addOnsSection.getString(context),
        icon: Icons.add_circle_outline_rounded,
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SwitchListTile(
            contentPadding: EdgeInsets.zero,
            title: MyText(text: AppLocale.enableAddOns.getString(context), fontWeight: FontWeight.w700, fontSize: 16),
            subtitle: MyText(text: AppLocale.addonsSubtitle.getString(context), fontSize: 13, color: Colors.grey.shade600),
            value: enableAddons,
            activeColor: primaryColor,
            onChanged: (v) => setState(() {
              enableAddons = v;
          ...
          if (enableAddons) ...[
            ...
            TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                decoration: _dec(AppLocale.addOnName.getString(context), Icons.label_outline_rounded)),
            const SizedBox(height: 16),
            TextFormField(
                controller: addonPriceController,
                keyboardType: TextInputType.number,
                decoration: _dec(AppLocale.addOnPrice.getString(context), Icons.currency_rupee_rounded)),
            const SizedBox(height: 16),
            SizedBox(
              width: double.infinity,
              height: 48,
              child: OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14))),
                icon: const Icon(Icons.add_rounded),
                label: MyText(text: AppLocale.addAddOn.getString(context), fontWeight: FontWeight.bold, fontSize: 15),
              ),
            ),
  ...
  Widget _buildInventorySection() => _sectionCard(
        title: AppLocale.inventoryDetails.getString(context),
        icon: Icons.inventory_2_outlined,
        child: Column(children: [
          TextFormField(
              controller: foodStockController,
              keyboardType: TextInputType.number,
              decoration: _dec(AppLocale.stockQuantity.getString(context), Icons.inventory_2_outlined)),
          const SizedBox(height: 16),
          TextFormField(
              controller: foodDescriptionController,
              maxLines: 3,
              decoration: _dec(AppLocale.descriptionOptional.getString(context), Icons.description_outlined)),
        ]),
      );
  ...
  Widget _buildSubmitButton() => SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: MyText(
            text: _isEditing ? AppLocale.updateProduct.getString(context) : AppLocale.addProduct.getString(context),
            fontSize: 17,
            color: Colors.white,
            fontWeight: FontWeight.bold,
          ),
