  ...
  Future<void> _deleteCategory(CategoryModel cat) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: MyText(text: AppLocale.deleteCategory.getString(context), fontWeight: FontWeight.bold),
        content: Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: MyText(
                text: AppLocale.deleteCategoryMsg.getString(context),
                fontSize: 13.5,
              ),
            ),
          ]),
    ...
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          ...
          MyText(
            text: '${_categories.length}${AppLocale.totalItems.getString(context)}',
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: AppLocale.searchCategories.getString(context),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            MyText(
              text: isSearch ? AppLocale.noCategoriesFound.getString(context) : AppLocale.noCategories.getString(context),
              fontSize: 17,
              fontWeight: FontWeight.bold,
              color: const Color(0xFF1A1A1A),
            ),
