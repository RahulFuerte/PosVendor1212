        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              MyText(text: AppLocale.selectImageSource.getString(context), fontSize: 18, fontWeight: FontWeight.bold),
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_isEditing) {
        ...
        if (mounted) SnackBarUtils.showSuccess(context, AppLocale.categoryUpdated.getString(context));
      } else {
        await _service.createCategory(_nameController.text.trim(), imageUrl);
        if (mounted) SnackBarUtils.showSuccess(context, AppLocale.categoryCreated.getString(context));
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(
          text: _isEditing ? AppLocale.editCategory.getString(context) : AppLocale.newCategory.getString(context),
          color: Colors.white,
            ...
            Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    MyText(
                      text: AppLocale.categoryDetails.getString(context),
                      fontSize: 18,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: AppLocale.egBeverages.getString(context),
                        ...
                        validator: (v) => v == null || v.trim().isEmpty ? AppLocale.categoryNameIsRequired.getString(context) : null,
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: MyText(
                          text: _isEditing ? AppLocale.editCategory.getString(context) : AppLocale.createCategory.getString(context),
                          fontSize: 16,
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                        ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          MyText(
            text: AppLocale.tapToAddCategoryImage.getString(context),
            color: primaryColor.withOpacity(0.8),
            fontWeight: FontWeight.w600,
            fontSize: 16,
          ),
          const SizedBox(height: 6),
          MyText(text: AppLocale.uploadHighQualityImage.getString(context), color: Colors.grey.shade600, fontSize: 13),
        ],
      ),
    );
  }
