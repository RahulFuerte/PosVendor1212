              ...
              Row(
                ...
                children: [
                  _buildImageSourceOption(
                    ...
                    label: AppLocale.camera.getString(context),
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  _buildImageSourceOption(
                    ...
                    label: AppLocale.gallery.getString(context),
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  if (_imageFile != null || _imageUrl != null)
                    _buildImageSourceOption(
                      icon: Icons.delete,
                      label: AppLocale.remove.getString(context),
                      color: Colors.red,
                      onTap: () {
                        Navigator.pop(context);
                        setState(() {
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: MyText(
                                text: AppLocale.addShopLogo.getString(context),
                                fontSize: 14,
                            ...
                            // Form Header
                            MyText(
                              text: AppLocale.receiptDetails.getString(context),
                              fontSize: 22,
                              fontWeight: FontWeight.bold,
                            ...
                            const SizedBox(height: 8),
                            MyText(
                              text: AppLocale.pleaseFillInformationBelow.getString(context),
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
                            ...
                            _buildTextField(
                              ...
                              label: AppLocale.shopName.getString(context),
                              hint: AppLocale.shopName.getString(context),
                              icon: Icons.store,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return AppLocale.shopNameIsRequired.getString(context);
                                }
                                return null;
                              },
                            ),
                            ...
                            _buildTextField(
                              ...
                              label: AppLocale.contact.getString(context),
                              hint: AppLocale.mobileNumberMustBe10Digits.getString(context),
                              icon: Icons.phone,
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return AppLocale.phoneIsRequired.getString(context);
                                }
                                if (value.length != 10) {
                            ...
                            _buildTextField(
                                ...
                                label: AppLocale.gstNoLabel.getString(context),
                                hint: AppLocale.gstNoLabel.getString(context),
                            ...
                            _buildTextField(
                              ...
                              label: AppLocale.fssaiNumber.getString(context),
                              hint: AppLocale.enterFssaiLicenseNumber.getString(context),
                            ...
                            _buildTextField(
                              ...
                              label: AppLocale.upiId.getString(context),
                              hint: AppLocale.enterUpiIdNumber.getString(context),
                            ...
                            _buildDropdownField(
                              label: AppLocale.businessCategoryLabel.getString(context),
                            ...
                            if (_registerTime != null) ...[
                              _buildReadOnlyField(
                                label: AppLocale.registrationDate.getString(context),
                            ...
                            _buildTextField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return AppLocale.addressIsRequired.getString(context);
                                }
                                return null;
                              },
                            ),
                            ...
                            MyText(
                              text: AppLocale.shopLocation.getString(context),
                              fontSize: 22,
                              fontWeight: FontWeight.bold,
                              color: Colors.black87,
                            ),
                            const SizedBox(height: 8),
                            MyText(
                              text: AppLocale.setGpsCoordinates.getString(context),
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
                            const SizedBox(height: 16),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            MyText(text: AppLocale.currentGpsCoordinates.getString(context), fontWeight: FontWeight.bold),
                                            const SizedBox(height: 4),
                                            MyText(
                                              text: (_latitude != null && _longitude != null)
                                                  ? 'Lat: ${_latitude!.toStringAsFixed(6)}, Lng: ${_longitude!.toStringAsFixed(6)}'
                                                  : AppLocale.locationNotSet.getString(context),
                                              fontSize: 12,
                                              color: Colors.grey[600],
                                            ),
                                          ],
                                      ...
                                      ElevatedButton(
                                        ...
                                        child: _isLocating ? const SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2)) : const Text('Update'),
                                      ),
                                    ],
                                  ),
                                  if (_latitude != null)
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          MyText(text: AppLocale.locationVerified.getString(context), color: Colors.green, fontSize: 11),
                                        ],
                                      ),
                                    ),
                                ],
                            ...
                            MyText(
                              text: AppLocale.taxSettings.getString(context),
                              fontSize: 22,
                              fontWeight: FontWeight.bold,
                              color: Colors.black87,
                            ),
                            const SizedBox(height: 8),
                            MyText(
                              text: AppLocale.configureTaxDisplay.getString(context),
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
                            const SizedBox(height: 16),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  MyText(
                                                    text: AppLocale.enableTaxOnReceipt.getString(context),
                                                    fontSize: 16,
                                                    fontWeight: FontWeight.w600,
                                                  ),
                                                  MyText(
                                                    text: printProvider.taxEnabled ? AppLocale.taxWillBeShown.getString(context) : AppLocale.taxWillNotBeShown.getString(context),
                                                    fontSize: 12,
                                                    color: Colors.grey[600],
                                                  ),
                                                ],
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: MyText(
                                                  text: '${AppLocale.totalTax.getString(context)}${PriceUtils.formatPrice(printProvider.cgstPercent + printProvider.sgstPercent).substring(1)}%',
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600,
                                                  color: primaryColor,
                                                ),
                            ...
                            MyText(
                              text: AppLocale.securitySettings.getString(context),
                              fontSize: 22,
                              fontWeight: FontWeight.bold,
                              color: Colors.black87,
                            ),
                            const SizedBox(height: 8),
                            MyText(
                              text: AppLocale.updateYourPasswordToSecureYourAccount.getString(context),
                              fontSize: 14,
                              color: Colors.grey[600],
                            ),
                            const SizedBox(height: 16),
                            _buildPasswordField(
                              ...
                              hint: AppLocale.enterNewPasswordToChange.getString(context),
        ...
        TextFormField(
          ...
          validator: (value) {
            if (value != null && value.isNotEmpty && value.length < 6) {
              return AppLocale.passwordMinChars.getString(context);
            }
            return null;
          },
        ),
