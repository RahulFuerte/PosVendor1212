    ...
    return Scaffold(
      ...
      body: FutureBuilder<Box<OrderModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (orders.isEmpty) {
            return  Center(child: MyText(text: AppLocale.noSavedOrders.getString(context)));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: MyText(text: '${AppLocale.orderHash.getString(context)}${order.billNumber}'),
                subtitle: MyText(text: '${AppLocale.totalAmount.getString(context)}: ₹${order.totalAmount}'),
                trailing: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        setState(() {});
                        if (mounted) {
                          SnackBarUtils.showSuccess(context, AppLocale.orderDeleted.getString(context));
                        }
                      },
                    ),
                  ],
