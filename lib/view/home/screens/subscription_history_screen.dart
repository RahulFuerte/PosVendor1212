    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          MyText(text: AppLocale.noTransactionsYet.getString(context), fontSize: 20, fontWeight: FontWeight.bold, color: const Color(0xFF1E293B)),
          const SizedBox(height: 8),
          MyText(text: AppLocale.noTransactionsMsg.getString(context),
