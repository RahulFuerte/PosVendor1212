  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (context, snapshot) {
        ...
        return Row(
          children: [
            _item(context, AppLocale.dineIn.getString(context), OrderType.dineIn, selected),
            _item(context, AppLocale.pickUp.getString(context), OrderType.pickUp, selected),
            _item(context, AppLocale.delivery.getString(context), OrderType.delivery, selected),
          ],
        );
      },
    );
