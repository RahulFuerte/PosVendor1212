    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const MyText(
            text: 'Choose a plan that fits your restaurant scale.\nSimple and transparent pricing.',
            fontSize: 14,
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                if (isActive && _expiryDate != null)
                  MyText(
                    text: 'Expires on: ${_expiryDate!.day}/${_expiryDate!.month}/${_expiryDate!.year}',
                    fontSize: 12,
                    color: const Color(0xFF64748B),
                  ),
                if (!isActive)
                  const MyText(
                    text: 'Select a plan below to continue using premium features.',
                    fontSize: 12,
                    maxLines: 2,
                    color: Color(0xFF64748B),
                  ),
          ...
          if (isTrial)
            Container(
              ...
              child: const MyText(text: 'TRIAL', color: Colors.orange, fontSize: 10, fontWeight: FontWeight.bold),
            ),
        ],
      ),
    );
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          MyText(
                            text: '${plan.durationInDays} Days access',
                            fontSize: 12,
                            color: const Color(0xFF64748B),
                          ),
                        ],
  ...
  void _handleSubscription(SubscriptionPlanModel plan) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: MyText(text: 'Activate ${plan.name}', fontWeight: FontWeight.bold),
        content: MyText(
          text: 'Are you sure you want to upgrade to the ${plan.name} plan for ₹${plan.price.toStringAsFixed(0)}?',
          color: const Color(0xFF64748B),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
            child: const MyText(text: 'Maybe Later', color: Color(0xFF64748B)),
          ),
          Padding(
            ...
            child: ElevatedButton(
              ...
              child: const MyText(text: 'Yes, Upgrade', color: Colors.white, fontWeight: FontWeight.bold),
            ),
          ),
        ],
      ),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const MyText(text: 'Subscription Active!', fontSize: 22, fontWeight: FontWeight.bold),
            const SizedBox(height: 8),
            const MyText(
              text: 'Welcome to the premium experience. All features are now unlocked for your restaurant.',
              textAlign: TextAlign.center,
              color: Color(0xFF64748B),
            ),
            const SizedBox(height: 24),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const MyText(text: 'Great!', color: Colors.white, fontWeight: FontWeight.bold),
              ),
            ),
          ],
        ),
