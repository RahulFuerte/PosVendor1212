...
class OnboardingScreenState extends State<OnboardingScreen> with TickerProviderStateMixin {
  ...
  List<Map<String, String>> _buildPages(BuildContext context) => [
        {
          "image": "assets/images/logo-green.png",
          "title": AppLocale.onboardTitle1.getString(context),
          "subtitle": AppLocale.onboardSubtitle1.getString(context),
        },
        {
          "image": "assets/images/razorpay.png",
          "title": AppLocale.onboardTitle2.getString(context),
          "subtitle": AppLocale.onboardSubtitle2.getString(context),
        },
      ];
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                _buildBottomSection(pages.length),
              ],
            ),
          ),
        ],
  ...
  Widget _buildBottomSection(int pageCount) {
