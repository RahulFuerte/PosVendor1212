...
class _SyncProgressDialogState extends State<SyncProgressDialog>
    ...
    return Column(
      children: [
        ...
        if (_itemsSynced > 0) ...[
          ...
          MyText(
            text: '$_itemsSynced${AppLocale.itemsSynced.getString(context)}',
            fontSize: 14,
      ...
      return Row(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: MyText(text: AppLocale.retry.getString(context)),
          ),
        ],
      );
    }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: AlertDialog(
        title: MyText(text: AppLocale.syncProgress.getString(context),
          textAlign: TextAlign.center,
        ),
        content: SizedBox(
          width: 300,
