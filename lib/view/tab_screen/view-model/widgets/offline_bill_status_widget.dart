  ...
  void _showSyncDetails(OfflineBillSyncResult result) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: MyText(text: AppLocale.syncDetails.getString(context)),
          ...
          child: Column(
            ...
            children: [
              ...
              if (result.syncedBillIds.isNotEmpty) ...[
                ...
                MyText(text: AppLocale.syncedBills.getString(context), fontWeight: FontWeight.bold),
                ...result.syncedBillIds.take(5).map((id) => MyText(text: '• ${id.length > 20 ? '${id.substring(0, 20)}...' : id}')),
                if (result.syncedBillIds.length > 5)
                  MyText(text: '•${AppLocale.andMore.getString(context)}${result.syncedBillIds.length - 5}${AppLocale.more.getString(context)}'),
              ],
              if (result.failedBillIds.isNotEmpty) ...[
                const SizedBox(height: 8),
                MyText(text: AppLocale.failedBills.getString(context), fontWeight: FontWeight.bold, color: Colors.red),
                ...
                if (result.failedBillIds.length > 3)
                  MyText(text: '•${AppLocale.andMore.getString(context)}${result.failedBillIds.length - 3}${AppLocale.more.getString(context)}', color: Colors.red),
              ],
            ],
          ),
        ),
  ...
  Widget _buildSyncStatusIndicator() {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            MyText(
              text: '$_offlineBillsCount${AppLocale.pendingSuffix.getString(context)}',
              color: Colors.orange,
              fontSize: 11,
              fontWeight: FontWeight.w500,
            ),
    ...
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.cloud_done, size: 14, color: primaryColor),
          const SizedBox(width: 4),
          MyText(
            text: AppLocale.synced.getString(context),
            color: primaryColor,
            fontSize: 11,
            fontWeight: FontWeight.w500,
          ),
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: MyText(
                  text: AppLocale.syncStatus.getString(context),
          ...
          if (_offlineBillsCount > 0) ...[
            const SizedBox(height: 8),
            MyText(
              text: '$_offlineBillsCount ${AppLocale.pendingSync.getString(context)}',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: MyText(
                      text: '${AppLocale.errorPrefix.getString(context)}$_lastSyncError',
          ...
          if (_lastSyncTime != null) ...[
            const SizedBox(height: 8),
            MyText(
              text: '${AppLocale.lastSync.getString(context)}${_formatDateTime(_lastSyncTime!)}',
          ...
          if (_offlineBillsCount > 0 && _isConnected && !_isSyncing) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: MyText(text: AppLocale.syncNow.getString(context), fontSize: 13),
